...
The final data set can be found in the `Tidy.txt` file, which can be read into R with `read.table("Tidy.txt", header = TRUE)`. A detailed description of the variables can be found in `CodeBook.md`. T
